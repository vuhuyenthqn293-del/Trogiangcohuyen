...
<div class="main-header">
    ...
    <p>Tác giả: Vũ Thị Huyên - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0838003293</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vũ Thị Huyên - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0838003293</div>", unsafe_allow_html=True)
